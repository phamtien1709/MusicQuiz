...
BasicGame.Game.prototype = {
    create: function () {
        this.firingTimer = 0; this.bulletTime = 0;
        this.score = 0;
        this.livingEnemies = [];
    ...
    createAliens: function () {
        for (var y = 0; y < 4; y++) {
            for (var x = 0; x < 10; x++) {
                ...
                alien.animations.add('fly', [0, 1, 2, 3], 20, true); alien.play('fly');
    ...
    blabloble: function () {
        // this is a function i write bescause i can't think anymore now
    }
};